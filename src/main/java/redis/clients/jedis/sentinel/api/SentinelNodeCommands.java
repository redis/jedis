 ...
 *
 * <p>
 * Redis Sentinel instances support a subset of Redis' commands  in addition to all SENTINEL subcommands.
 * </p>
 *
 * @see SentinelCommands
 * @see <a href="https://redis.io/docs/latest/operate/oss_and_stack/management/sentinel/">Redis Sentinel Documentation</a>
 * @since 7.5.0
 */
