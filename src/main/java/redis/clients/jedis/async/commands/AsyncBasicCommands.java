...
public interface AsyncBasicCommands {
    ...
    void debug(final AsyncResponseCallback<String> callback,
    ...
    void slaveof(final AsyncResponseCallback<String> callback,
    ...
    void waitReplicas(final AsyncResponseCallback<Long> callback,
	    final int replicas, final long timeout);
