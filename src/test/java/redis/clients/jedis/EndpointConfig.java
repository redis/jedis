...
public class EndpointConfig {
  ...
  public EndpointConfig(HostAndPort hnp, String username, String password, boolean tls,
    ...
    this.endpoints = Collections
        .singletonList(URI.create(getURISchema(tls) + hnp.getHost() + ":" + hnp.getPort()));
  ...
  public class EndpointURIBuilder {
    ...
    public URI build() {
      String userInfo = !(this.username.isEmpty() && this.password.isEmpty())
          ...
          : "";
      return URI
          .create(getURISchema(this.tls) + userInfo + getHost() + ":" + getPort() + this.path);
    }
  }
  ...
  public DefaultJedisClientConfig.Builder getClientConfigBuilder() {
    DefaultJedisClientConfig.Builder builder = DefaultJedisClientConfig.builder().password(password)
        .ssl(tls);
