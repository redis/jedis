...
public class AsyncBinaryValuesCommandsTest extends AsyncJedisCommandTestBase {
	...
	assertTrue(Arrays.equals(binaryValue,
	...
	asyncJedis.set(STRING_CALLBACK.withReset(), bfoo, binaryValue, bnx,
		bex, expireSeconds);
	assertTrue(Keyword.OK.name().equalsIgnoreCase(
		STRING_CALLBACK.getResponseWithWaiting(1000)));
	...
	// nx should fail if value exists
	asyncJedis.set(STRING_CALLBACK.withReset(), bfoo, binaryValue, bxx,
		bex, expireSeconds);
	assertEquals(Keyword.OK.name(),
		STRING_CALLBACK.getResponseWithWaiting(1000));
	...
	assertEquals(expected,
		BYTE_ARRAY_LIST_CALLBACK.getResponseWithWaiting(1000));
    ...
    @Test
    public void mset() {
	asyncJedis.mset(STRING_CALLBACK.withReset(), bfoo, binaryValue, bbar,
		bfoo);
	assertEquals(Keyword.OK.name(),
		STRING_CALLBACK.getResponseWithWaiting(1000));
    ...
    @Test
    public void msetnx() {
	asyncJedis.msetnx(LONG_CALLBACK.withReset(), bfoo, binaryValue, bbar,
		bfoo);
	assertEquals(new Long(1), LONG_CALLBACK.getResponseWithWaiting(1000));
	...
	asyncJedis.msetnx(LONG_CALLBACK.withReset(), bfoo, bbar,
		"bar2".getBytes(), "foo2".getBytes());
	assertEquals(new Long(0), LONG_CALLBACK.getResponseWithWaiting(1000));
	...
	assertEquals(new Long(binaryValue.length),
		LONG_CALLBACK.getResponseWithWaiting(1000));
	...
	asyncJedis.substr(BYTE_ARRAY_CALLBACK.withReset(), bfoo,
	...
	assertEquals(binaryValue.length,
		LONG_CALLBACK.getResponseWithWaiting(1000).longValue());
    }
}