...
/**
 * * A class represent an node (graph entity). In addition to the base class id and properties, a
 * node has labels.
...
public class Node extends GraphEntity {
  ...
  /**
   * Use this constructor to reduce memory allocations when labels or properties are added to the
   * node
