...
public class BinaryJedisCluster implements BinaryJedisClusterCommands,
  ...
  public BinaryJedisCluster(Set<HostAndPort> jedisClusterNode, int connectionTimeout, int soTimeout, int maxAttempts, String user, String password, String clientName, GenericObjectPoolConfig poolConfig) {
    ...
    this.timeout = Duration.ofMillis(Math.max(connectionTimeout, soTimeout));
  }
  ...
  public List<byte[]> hmget(final byte[] key, final byte[]... fields) {
    return new JedisClusterCommand<List<byte[]>>(connectionHandler, maxAttempts, this.timeout) {
      @Override
  ...
  public Set<byte[]> hkeys(final byte[] key) {
    return new JedisClusterCommand<Set<byte[]>>(connectionHandler, maxAttempts, this.timeout) {
      @Override
  ...
  public Map<byte[], byte[]> hgetAll(final byte[] key) {
    return new JedisClusterCommand<Map<byte[], byte[]>>(connectionHandler, maxAttempts, this.timeout) {
      @Override
  ...
  public ScanResult<byte[]> scan(final byte[] cursor, final ScanParams params) {
    ...
    return new JedisClusterCommand< ScanResult<byte[]>>(connectionHandler, maxAttempts, this.timeout) {
      @Override
