...
public interface ArrayPipelineCommands {
   ...
   * single-range overload of {@link #ardelrange(String, LongRange...)}.
   * <p>
   ...
   */
  @Experimental
  Response<List<Long>> argrep(String key, ArgrepParams params);
   ...
   */
  @Experimental
  Response<List<KeyValue<Long, String>>> argrepWithValues(String key, ArgrepParams params);
   ...
   * single-value overload of {@link #arinsert(String, String...)}.
   * <p>
   ...
   * @param key the name of the key that holds the array
   * @return a {@link Response} that resolves to {@code 0L} for missing keys, the next insert index
   *         when one is available, or {@code null} when the cursor is exhausted
   * @since 8.0
   */
  @Experimental
   ...
   * overload of {@link #arring(String, long, String...)}.
   * <p>
   ...
   * overload of {@link #arset(String, long, String...)}.
   * <p>
