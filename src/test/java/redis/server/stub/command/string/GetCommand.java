...
/**
 * GET key Get the value of key. If the key does not exist, null is returned. An error is returned
 * if the value stored at key is not a string. Return value: - Bulk string reply: the value of key -
