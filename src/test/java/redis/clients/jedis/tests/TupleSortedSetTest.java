...
public class TupleSortedSetTest extends JedisCommandTestBase {
    ...
    private final byte[] ba = {0x0A};
    private final byte[] bb = {0x0B};
    private final byte[] bc = {0x0C};
    private final byte[] bd = {0x0D};
    private final byte[] be = {0x0E};
    private final byte[] bf = {0x0F};

    @Test
    public void testBinary() {
        SortedSet<Tuple> sortedSet = new TreeSet<>();
