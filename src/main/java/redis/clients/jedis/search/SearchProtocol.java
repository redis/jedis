...
public class SearchProtocol {
  ...
  public enum SearchKeyword implements Rawable {
    ...
    READ, COUNT, ADD, TEMPORARY, STOPWORDS, NOFREQS, NOFIELDS, NOOFFSETS, NOHL, SET, GET, ON, AS,
    ...
    NOSTEM, NOINDEX, PHONETIC, WEIGHT, CASESENSITIVE, WITHSUFFIXTRIE, EXPLAINSCORE, LOAD, APPLY,
    GROUPBY, WITHCURSOR, MAXIDLE;
