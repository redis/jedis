 ...
 * username and password. Redis <6 supports only password. For MVP: We accept any authentication
 * without validation. Return value: - Simple string reply: OK if authentication successful
 */
