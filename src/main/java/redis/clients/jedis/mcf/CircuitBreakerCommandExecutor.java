 ...
 *         <p>
 *         CommandExecutor with built-in retry, circuit-breaker, and failover to another cluster/database endpoint. With
 *         this executor users can seamlessly failover to Disaster Recovery (DR), Backup, and Active-Active cluster(s)
