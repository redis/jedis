...
@Tag("integration")
public class HybridSearchTest extends RedisModuleCommandsTestBase {
  ...
  @AfterEach
  public void cleanUp() {
    if (client.ftList().contains(INDEX_NAME)) {
      client.ftDropIndex(INDEX_NAME);
    }
  }

  public HybridSearchTest(RedisProtocol protocol) {
    super(protocol);
  }
  ...
  public void testComprehensiveFtHybridWithAllFeatures() {
    ...
    assertOK(client.ftCreate(INDEX_NAME,
    ...
    HybridReply reply = client.ftHybrid(INDEX_NAME, hybridArgs);
