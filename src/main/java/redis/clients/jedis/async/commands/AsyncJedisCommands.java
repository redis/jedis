...
public interface AsyncJedisCommands {
    ...
    void expireAt(AsyncResponseCallback<Long> callback, String key,
	    long unixTime);
    ...
    void pexpire(final AsyncResponseCallback<Long> callback, final String key,
	    final long milliseconds);

    void pexpireAt(final AsyncResponseCallback<Long> callback,
	    final String key, final long millisecondsTimestamp);
    ...
    void restore(final AsyncResponseCallback<String> callback,
	    final String key, final int ttl, final byte[] serializedValue);
    ...
    void getrange(AsyncResponseCallback<String> callback, String key,
    ...
    void incrByFloat(final AsyncResponseCallback<Double> callback,
	    final String key, final double increment);
    ...
    void set(final AsyncResponseCallback<String> callback, final String key,
	    final String value, final String nxxx, final String expx,
	    final long time);

    void setbit(AsyncResponseCallback<Boolean> callback, String key,
    ...
    void setex(AsyncResponseCallback<String> callback, String key, int seconds,
	    String value);

    void setrange(AsyncResponseCallback<Long> callback, String key,
	    long offset, String value);

    void strlen(AsyncResponseCallback<Long> callback, String key);

    void substr(AsyncResponseCallback<String> callback, String key, int start,
	    int end);
    ...
    void hexists(AsyncResponseCallback<Boolean> callback, String key,
	    String field);
    ...
    void hincrBy(AsyncResponseCallback<Long> callback, String key,
    ...
    void hmget(AsyncResponseCallback<List<String>> callback, String key,
	    String... fields);

    void hmset(AsyncResponseCallback<String> callback, String key,
	    Map<String, String> hash);

    void hset(AsyncResponseCallback<Long> callback, String key, String field,
	    String value);

    void hsetnx(AsyncResponseCallback<Long> callback, String key, String field,
	    String value);
    ...
    void linsert(AsyncResponseCallback<Long> callback, String key,
    ...
    void lpush(AsyncResponseCallback<Long> callback, String key,
	    String... strings);

    void lpushx(AsyncResponseCallback<Long> callback, String key,
	    String... strings);

    void lrange(AsyncResponseCallback<List<String>> callback, String key,
	    long start, long end);

    void lrem(AsyncResponseCallback<Long> callback, String key, long count,
	    String value);

    void lset(AsyncResponseCallback<String> callback, String key, long index,
	    String value);

    void ltrim(AsyncResponseCallback<String> callback, String key, long start,
	    long end);

    void rpop(AsyncResponseCallback<String> callback, String key);

    void rpush(AsyncResponseCallback<Long> callback, String key,
	    String... strings);

    void rpushx(AsyncResponseCallback<Long> callback, String key,
	    String... strings);

    // set section

    void sadd(AsyncResponseCallback<Long> callback, String key,
	    String... members);

    void scard(AsyncResponseCallback<Long> callback, String key);

    void sismember(AsyncResponseCallback<Boolean> callback, String key,
	    String members);
    ...
    void srem(AsyncResponseCallback<Long> callback, String key,
	    String... members);

    // sorted set section

    void zadd(AsyncResponseCallback<Long> callback, String key, double score,
	    String member);

    void zadd(AsyncResponseCallback<Long> callback, String key,
	    Map<String, Double> scoreMembers);

    void zcard(AsyncResponseCallback<Long> callback, String key);

    void zcount(AsyncResponseCallback<Long> callback, String key, double min,
	    double max);

    void zcount(AsyncResponseCallback<Long> callback, String key, String min,
	    String max);

    void zincrby(AsyncResponseCallback<Double> callback, String key,
	    double score, String member);

    void zrange(AsyncResponseCallback<Set<String>> callback, String key,
	    long start, long end);

    void zrangeWithScores(AsyncResponseCallback<Set<Tuple>> callback,
	    String key, long start, long end);

    void zrangeByScore(AsyncResponseCallback<Set<String>> callback, String key,
    ...
    void zrangeByScoreWithScores(AsyncResponseCallback<Set<Tuple>> callback,
    ...
    void zrem(AsyncResponseCallback<Long> callback, String key,
	    String... members);

    void zremrangeByRank(AsyncResponseCallback<Long> callback, String key,
	    long start, long end);

    void zremrangeByScore(AsyncResponseCallback<Long> callback, String key,
	    double start, double end);

    void zremrangeByScore(AsyncResponseCallback<Long> callback, String key,
	    String start, String end);

    void zrevrange(AsyncResponseCallback<Set<String>> callback, String key,
	    long start, long end);

    void zrevrangeWithScores(AsyncResponseCallback<Set<Tuple>> callback,
	    String key, long start, long end);

    void zrevrangeByScore(AsyncResponseCallback<Set<String>> callback,
    ...
    void zrevrangeByScoreWithScores(AsyncResponseCallback<Set<Tuple>> callback,
	    String key, double max, double min);
    ...
    void zrevrank(AsyncResponseCallback<Long> callback, String key,
	    String member);

    void zscore(AsyncResponseCallback<Double> callback, String key,
	    String member);
