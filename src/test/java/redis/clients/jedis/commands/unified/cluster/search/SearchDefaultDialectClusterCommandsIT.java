...
public class SearchDefaultDialectClusterCommandsIT extends SearchDefaultDialectCommandsTestBase {
  ...
  public SearchDefaultDialectClusterCommandsIT(RedisProtocol protocol) {
    super(protocol);
  }
