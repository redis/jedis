...
public interface BitCommands {
  ...
  /**
   * <b><a href="http://redis.io/commands/setbit">SetBit Command</a></b> Sets or clears the bit at
  ...
  /**
   * <b><a href="http://redis.io/commands/getbit">GetBit Command</a></b> Returns the bit value at
   * offset in the string value stored at key.
   * <p>
   * Time complexity: O(1)
   * @param key
  ...
  /**
   * <b><a href="http://redis.io/commands/bitcount">Bitcount Command</a></b> Count the number of set
   * bits (population counting) in a string.
   * @param key
  ...
  /**
   * <b><a href="http://redis.io/commands/bitcount">Bitcount Command</a></b> Count the number of set
   * bits (population counting) in a string only in an interval start and end.
   * <p>
   * Like for the GETRANGE command start and end can contain negative values in order to index bytes
   * starting from the end of the string, where -1 is the last byte, -2 is the penultimate, and so
   * forth.
   * @param key
  ...
  /**
   * <b><a href="http://redis.io/commands/bitpos">Bitpos Command</a></b> Return the position of the
  ...
  /**
   * <b><a href="http://redis.io/commands/bitfield">Bitfield Command</a></b> The command treats a
   * Redis string as an array of bits, and is capable of addressing specific integer fields of
   * varying bit widths and arbitrary non (necessary) aligned offset.
   * @param key
   ...
   * between multiple keys (containing string values) and store the result in the destKey.
