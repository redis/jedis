 ...
 * name - ID - Get client ID - SETINFO - Set client info (LIB-NAME, LIB-VER) - TRACKING -
...
public class ClientCommand implements RedisCommand {
   ...
   * For testing purposes, we only handle ON/OFF and ignore optional parameters. This is sufficient
   * for CacheConnection.initializeClientSideCache().
   */
