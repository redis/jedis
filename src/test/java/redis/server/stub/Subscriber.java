 ...
 *
 * <p>Abstracts the concept of a subscriber from the implementation details of client connections.
 * This allows {@link PubSubManager} to work with any type of subscriber, not just
 * {@link ClientHandler}.
 *
 ...
 * </ul>
 *
 * <p><b>Subscription Management</b>: Subscribers are properly managed through:
 * <ul>
 ...
 * </ul>
 *
 * <p><b>Thread Safety</b>: Implementations must ensure {@link #sendPushMessage(String...)} is
...
public interface Subscriber {
   ...
   *
   * <p>Push messages are RESP3 protocol messages sent asynchronously to subscribers (e.g., pub/sub
   * notifications, server events). This method must be thread-safe.
   *
   * <p><b>RESP3 Push Format</b>:
   * <pre>
   ...
   *   <li>Pattern message: {@code sendPushMessage("pmessage", "news.*", "news.sports", "Game on!")}</li>
