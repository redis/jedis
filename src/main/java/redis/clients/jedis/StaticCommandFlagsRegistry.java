...
/**
 * Static implementation of CommandFlagsRegistry. This class is auto-generated by CommandFlagsRegistryGenerator. DO NOT EDIT
 * MANUALLY.
...
public class StaticCommandFlagsRegistry implements CommandFlagsRegistry {
    ...
    /**
     * Get the flags for a given command. Flags are looked up from a static registry based on the command arguments. This
     * approach significantly reduces memory usage by sharing flag instances across all CommandObject instances.
     * <p>
    ...
    static class Commands {
        ...
        final JedisByteMap<CommandMeta> commands = new JedisByteMap<CommandMeta>();
