...
public interface ArrayPipelineBinaryCommands {
   ...
   * @since 8.0
   */
  Response<Long> ardelrange(byte[] key, long[]... ranges);
   ...
   * @return a {@link Response} that resolves to the list of values in traversal order;
   *         empty slots appear as {@code null} entries
   * @since 8.0
   */
   ...
   *         or alternating index/value pairs when {@code WITHVALUES} is set
   * @since 8.0
   */
  Response<List<Object>> argrep(byte[] key, long start, long end, ArgrepParams params);
   ...
   * @since 8.0
   */
  Response<Map<String, Object>> arinfo(byte[] key);
   ...
   * @since 8.0
   */
  Response<Map<String, Object>> arinfo(byte[] key, boolean full);
   ...
   * @since 8.0
   */
  Response<Object> arop(byte[] key, long start, long end, ArrayOp op);
   ...
   * @since 8.0
   */
  Response<Long> aropMatch(byte[] key, long start, long end, byte[] value);
   ...
   * @since 8.0
   */
  Response<List<Object>> arscan(byte[] key, long start, long end);
   ...
   * @since 8.0
   */
  Response<List<Object>> arscan(byte[] key, long start, long end, long limit);
