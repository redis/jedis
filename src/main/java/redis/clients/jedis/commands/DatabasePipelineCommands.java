...
public interface DatabasePipelineCommands {
  ...
  /**
   * Binary version of {@link DatabasePipelineCommands#migrate(String, int, String, int, int)
   * MIGRATE}.
  ...
  /**
   * Binary version of
   * {@link DatabasePipelineCommands#migrate(String, int, int, int, MigrateParams, String...)
   * MIGRATE}.
