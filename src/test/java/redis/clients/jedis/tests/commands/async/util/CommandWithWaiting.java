...
public class CommandWithWaiting {
    ...
    public static void setbit(AsyncJedis j, String key, long offset,
	    boolean value) {
    ...
    public static void zadd(AsyncJedis j, byte[] key, double score,
	    byte[] member) {
	AsyncJUnitTestCallback<Long> callback = new AsyncJUnitTestCallback<Long>();
    ...
    public static void zadd(AsyncJedis j, String key, double score,
	    String member) {
	AsyncJUnitTestCallback<Long> callback = new AsyncJUnitTestCallback<Long>();
	j.zadd(callback, key, score, member);
	waitForResponse(callback);
