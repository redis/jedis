...
public class ShardedPipeline extends MultiNodePipelineBase implements PipelineCommands, PipelineBinaryCommands,
    RedisModulePipelineCommands {

  private final ShardedConnectionProvider provider;
  private final ShardedCommandObjects commandObjects;
