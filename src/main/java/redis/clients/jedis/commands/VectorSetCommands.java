...
public interface VectorSetCommands {
   ...
   */
  VSimResult vsim(String key, float[] vector, VSimParams params);
   ...
   * @return VSimResult containing similar elements and optionally their scores
   */
  VSimResult vsimByElement(String key, String element, VSimParams params);
   ...
   * @return list of similar elements
   */
  List<String> vsimFP32(String key, byte[] vectorBlob);
   ...
   * @return VSimResult containing similar elements and optionally their scores
   */
  VSimResult vsimFP32(String key, byte[] vectorBlob, VSimParams params);
