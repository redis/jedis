...
public class JsonExample {
  ...
  public void run() {
    ...
    List<Long> res19 = jedis.jsonArrInsertWithEscape("riders", new Path2("$"), 1, "Prickett",
      "Royce", "Castilla");
    ...
    // STEP_START obj
    String res25 = jedis.jsonSet("bike:1", new Path2("$"), new JSONObject().put("model", "Deimos")
        .put("brand", "Ergonom").put("price", 4972));
    ...
    String inventory_json = "{" + "    \"inventory\": {" + "        \"mountain_bikes\": ["
        + "            {" + "                \"id\": \"bike:1\","
        + "                \"model\": \"Phoebe\","
    ...
    // REMOVE_START
    Assert.assertEquals("[[{\"specs\":{\"material\":\"carbon\",\"weight\":13.1},\"price\":1920,"
        + "\"description\":\"This is a mid-travel trail slayer that is a "
        ...
        + "for this price.\",\"model\":\"Mimas\",\"id\":\"bike:5\"}]]", res29.toString());
    // REMOVE_END

    // STEP_START get_mtnbikes
    Object res30 = jedis.jsonGet("bikes:inventory",
      new Path2("$.inventory.mountain_bikes[*].model"));
    System.out.println(res30); // >>> ["Phoebe","Quaoar","Weywot"]

    Object res31 = jedis.jsonGet("bikes:inventory", new Path2(
    ...
    // REMOVE_START
    Assert.assertEquals("[\"Phoebe\",\"Quaoar\",\"Weywot\",\"Salacia\",\"Mimas\"]",
      res33.toString());
    // REMOVE_END
    ...
    // STEP_START filter1
    Object res35 = jedis.jsonGet("bikes:inventory", new Path2(
    ...
    // REMOVE_START
    Assert.assertEquals("[{\"specs\":{\"material\":\"aluminium\",\"weight\":7.9},\"price\":2072,"
        ...
        + "\"Quaoar\",\"id\":\"bike:2\",\"colors\":[\"black\",\"white\"]}]", res35.toString());
    // REMOVE_END

    // STEP_START filter2
    Object res36 = jedis.jsonGet("bikes:inventory", new Path2(
    ...
    // STEP_START filter3
    Object res37 = jedis.jsonGet("bikes:inventory", new Path2(
    ...
    // STEP_START filter4
    jedis.jsonSet("bikes:inventory", new Path2("$.inventory.mountain_bikes[0].regex_pat"),
      "\"(?i)al\"");
    jedis.jsonSet("bikes:inventory", new Path2("$.inventory.mountain_bikes[1].regex_pat"),
      "\"(?i)al\"");
    jedis.jsonSet("bikes:inventory", new Path2("$.inventory.mountain_bikes[2].regex_pat"),
      "\"(?i)al\"");

    Object res38 = jedis.jsonGet("bikes:inventory", new Path2(
    ...
    List<Long> res43 = jedis.jsonArrAppendWithEscape("bikes:inventory", new Path2(
        "$.inventory.*[?(@.price<2000)].colors"), "\"pink\"");
    ...
    Assert.assertEquals("[[\"black\",\"silver\",\"\\\"pink\\\"\"],[\"black\",\"white\"],"
        + "[\"black\",\"silver\",\"\\\"pink\\\"\"]]", res44.toString());
    // REMOVE_END
