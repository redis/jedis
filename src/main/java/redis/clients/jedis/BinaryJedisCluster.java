...
public class BinaryJedisCluster implements BinaryJedisClusterCommands,
    ...
    @Override
    public Boolean setbit(final byte[] key, final long offset,
	    final boolean value) {
	return new JedisClusterCommand<Boolean>(connectionHandler, timeout,
		maxRedirections) {
	    @Override
    ...
    @Override
    public byte[] getrange(final byte[] key, final long startOffset,
	...
	return new JedisClusterCommand<Collection<byte[]>>(connectionHandler,
		timeout, maxRedirections) {
	    @Override
    ...
    @Override
    public Long linsert(final byte[] key, final Client.LIST_POSITION where,
    ...
    @Override
    public Object eval(final byte[] script, final byte[] keyCount,
	    final byte[]... params) {
    ...
    @Override
    public Object eval(final byte[] script, final int keyCount,
	    final byte[]... params) {
	return new JedisClusterCommand<Object>(connectionHandler, timeout,
		maxRedirections) {
	    @Override
    ...
    @Override
    public Object eval(final byte[] script, final List<byte[]> keys,
    ...
    @Override
    public Object evalsha(final byte[] sha1, final List<byte[]> keys,
	    final List<byte[]> args) {
	return new JedisClusterCommand<Object>(connectionHandler, timeout,
		maxRedirections) {
	    @Override
    ...
    @Override
    public Object evalsha(final byte[] sha1, final int keyCount,
	    final byte[]... params) {
	return new JedisClusterCommand<Object>(connectionHandler, timeout,
		maxRedirections) {
	    @Override
    ...
    /*
     * @Override public String watch(final byte[]... keys) { return new
     * JedisClusterCommand<String>(connectionHandler, timeout, maxRedirections)
     * {
     * 
     * @Override public String execute(Jedis connection) { return
     * connection.watch(keys); } }.runBinary(keys.length, keys); }
     * 
     * @Override public String unwatch() { // FIXME: We really need to know a
     * slot number (I mean key) where watch has been occurred return new
     * JedisClusterCommand<String>(connectionHandler, timeout, maxRedirections)
     * {
     * 
     * @Override public String execute(Jedis connection) { return
     * connection.unwatch(); } }.runBinary(null); }
     */
