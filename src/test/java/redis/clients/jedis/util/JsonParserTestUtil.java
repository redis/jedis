...
public class JsonParserTestUtil {
  public static CustomJacksonParser getCustomJacksonParser() {
    ObjectMapper om = new ObjectMapper();
    om.registerModule(new JavaTimeModule());
    om.disable(SerializationFeature.WRITE_DATES_AS_TIMESTAMPS);
    return new CustomJacksonParser(om);
  }
  public static class CustomJacksonParser implements JsonParser {
    private final ObjectMapper om;
    CustomJacksonParser(ObjectMapper om) {
      this.om = om;
    }
    @Override
  ...
  public static CustomGsonParser getCustomGsonParser() {
    ...
    return new CustomGsonParser(new GsonBuilder().registerTypeAdapter(Instant.class, new InstantAdapter()).create());
  }
  public static class CustomGsonParser implements JsonParser {
    private final Gson gson;
    public CustomGsonParser(Gson gson) {
      this.gson = gson;
    }
    @Override
    public <T> T fromJson(String value, Class<T> valueType) {
