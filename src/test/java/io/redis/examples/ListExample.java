...
public class ListExample {
  ...
  public void run() {
    ...
    String res12 = jedis.lmove("bikes:repairs", "bikes:finished", ListDirection.LEFT,
      ListDirection.LEFT);
    ...
    System.out.println(res21); // >>> [bike:very_important_bike, bike:important_bike, bike:1,
                               // bike:2, bike:3]
    // STEP_END
    ...
    assertEquals("[bike:very_important_bike, bike:important_bike, bike:1, bike:2, bike:3]",
      res21.toString());
    jedis.del("bikes:repairs");
    // REMOVE_END
