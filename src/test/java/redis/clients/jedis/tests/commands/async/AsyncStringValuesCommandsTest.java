...
public class AsyncStringValuesCommandsTest extends AsyncJedisCommandTestBase {
	...
	assertEquals(Protocol.Keyword.OK.name(),
		STRING_CALLBACK.getResponseWithWaiting(1000));
    ...
    public void mset() {
	asyncJedis
		.mset(STRING_CALLBACK.withReset(), "foo", "bar", "bar", "foo");
	assertEquals(Protocol.Keyword.OK.name(),
		STRING_CALLBACK.getResponseWithWaiting(1000));
	...
	asyncJedis
		.msetnx(LONG_CALLBACK.withReset(), "foo", "bar", "bar", "foo");
	assertEquals(new Long(1), LONG_CALLBACK.getResponseWithWaiting(1000));
	...
	asyncJedis.msetnx(LONG_CALLBACK.withReset(), "foo", "bar1", "bar2",
		"foo2");
	assertEquals(new Long(0), LONG_CALLBACK.getResponseWithWaiting(1000));
	...
	assertEquals("This is a string".length(), LONG_CALLBACK
		.getResponseWithWaiting(1000).longValue());
    }
	...
	assertEquals(new Long(1L + Integer.MAX_VALUE),
		LONG_CALLBACK.getResponseWithWaiting(1000));
    }
	...
	CommandWithWaiting
		.set(asyncJedis, "foo", Long.toString(Long.MAX_VALUE));
