...
public class JedisPooledTest {
  ...
  private static final HostAndPort hnp = HostAndPortUtil.getRedisServers().get(7);
  ...
  public void testResetValidPassword() {
    ConnectionFactory factory = new ConnectionFactory(HostAndPortUtil.getRedisServers().get(0),
