...
public interface RedisTimeSeriesPipelineCommands {
  ...
  Response<List<TSElements>> tsMRange(long fromTimestamp, long toTimestamp, String... filters);

  Response<List<TSElements>> tsMRange(TSMRangeParams multiRangeParams);

  Response<List<TSElements>> tsMRevRange(long fromTimestamp, long toTimestamp, String... filters);

  Response<List<TSElements>> tsMRevRange(TSMRangeParams multiRangeParams);

  Response<TSElement> tsGet(String key);

  Response<List<TSElements>> tsMGet(TSMGetParams multiGetParams, String... filters);
