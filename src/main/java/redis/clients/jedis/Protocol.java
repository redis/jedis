...
public final class Protocol {
  ...
  public static enum Command {
    ...
    // retun count of members submitted
    ...
    // Simple search - georadius nyc 40.7598464 -73.9798091 3 km
    // Search with distance returned - georadius nyc 40.7598464 -73.9798091 3 km withdistance
    // Distance search with sorting - georadius nyc 40.7598464 -73.9798091 3 km withdistance descending/ascending, we use ascending
    GEORADIUS,
    ...
    // Search radius by existing member - georadiusbymember nyc "wtc one" 7 km
    // Search around existing member with distances returned - georadiusbymember nyc "wtc one" 7 km withdist
    // Search with results in descending distance - georadiusbymember nyc "wtc one" 7 km withdistance desc
    // GeoJSON results - georadiusbymember nyc "wtc one" 7 km withgeojson
    // GeoJSON collection result - georadiusbymember nyc "wtc one" 7 km withgeojsoncollection
    GEORADIUSBYMEMBER ;
