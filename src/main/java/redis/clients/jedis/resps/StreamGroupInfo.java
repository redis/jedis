...
/**
 * This class holds information about a stream group. They can be accessed via getters. There is
 * also {@link StreamGroupInfo#getGroupInfo()} method that returns a generic {@code Map} in case
