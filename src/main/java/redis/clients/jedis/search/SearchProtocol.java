...
public class SearchProtocol {
  ...
  public enum SearchKeyword implements Rawable {
    ...
    WITHPAYLOADS, INFIELDS, SORTBY, ASC, DESC, PAYLOAD, LIMIT, HIGHLIGHT, FIELDS, TAGS, SUMMARIZE,
    FRAGS, LEN, SEPARATOR, INKEYS, RETURN, FILTER, GEOFILTER, ADD, INCR, MAX, FUZZY, DD, DEL, READ,
    COUNT, TEMPORARY, STOPWORDS, NOFREQS, NOFIELDS, NOOFFSETS, NOHL, SET, GET, ON, SORTABLE, UNF,
    @Deprecated ASYNC, PREFIX, LANGUAGE_FIELD, SCORE, SCORE_FIELD, SCORER, PAYLOAD_FIELD, PARAMS,
    AS, DIALECT, SLOP, TIMEOUT, INORDER, EXPANDER, MAXTEXTFIELDS, SKIPINITIALSCAN, WITHSUFFIXTRIE,
    NOSTEM, NOINDEX, PHONETIC, WEIGHT, CASESENSITIVE, EXPLAINSCORE, LOAD, APPLY, GROUPBY, MAXIDLE,
    WITHCURSOR;
