...
//    SUGLEN("FT.SUGLEN"),
  ...
  public enum SearchKeyword implements Rawable {
    ...
    RETURN, /*NOSAVE, PARTIAL, REPLACE,*/ FILTER, GEOFILTER, INCR, MAX, FUZZY, DD, DELETE, READ, COUNT,
    ADD, TEMPORARY, STOPWORDS, NOFREQS, NOFIELDS, NOOFFSETS, /*IF,*/ SET, GET, ON, ASYNC, PREFIX,
    LANGUAGE_FIELD, SCORE_FIELD, SCORE, PAYLOAD_FIELD, SCORER;
