...
//  }
  ...
  public static enum Command implements ProtocolCommand {
    ...
    KEYS, RANDOMKEY, RENAME, RENAMENX, DBSIZE, EXPIRE, EXPIREAT, PEXPIRE, PEXPIREAT, TTL, PTTL,
    SELECT, MIGRATE, ECHO,
    MULTI, DISCARD, EXEC, WATCH, UNWATCH, SORT, SORT_RO, INFO, SHUTDOWN, MONITOR, CONFIG, LCS, //
    GETSET, MGET, SETNX, SETEX, MSET, MSETNX, DECRBY, DECR, INCRBY, INCR, STRLEN, APPEND, SUBSTR, // <-- string
    SETBIT, GETBIT, BITPOS, SETRANGE, GETRANGE, BITCOUNT, BITOP, BITFIELD, // <-- bit (string)
    ...
    EVAL, EVALSHA, SCRIPT, SLOWLOG, OBJECT,
    SENTINEL, DUMP, RESTORE, INCRBYFLOAT, PSETEX, CLIENT, TIME,
    SCAN, HSCAN, SSCAN, ZSCAN, WAIT, CLUSTER, ASKING, READONLY, READWRITE, SLAVEOF, REPLICAOF, COPY,
    PFADD, PFCOUNT, PFMERGE, MODULE, ACL, TOUCH, SWAPDB, MEMORY,
