...
//  }
  ...
  public static enum Keyword implements Rawable {
    ...
    AGGREGATE, ALPHA, ASC, BY, DESC, GET, LIMIT, NO, NOSORT, OK, ONE, QUEUED, SET, STORE, WEIGHTS,
    WITHSCORES, RESETSTAT, REWRITE, RESET, FLUSH, EXISTS, LOAD, KILL, LEN, REFCOUNT, ENCODING,
    IDLETIME, GETNAME, SETNAME, LIST, MATCH, COUNT, ANY, TYPE, PING, UNLOAD, REPLACE, KEYS, PAUSE, DOCTOR,
    ...
    KEEPTTL, CH, WITHCOORD, WITHDIST, WITHHASH, STOREDIST, COPY, AUTH, AUTH2, INFO, CHANNELS, NUMPAT, NUMSUB;
  ...
  public static enum ClusterKeyword implements Rawable {
    ...
    MEET, RESET, INFO, FAILOVER, SLOTS, FORCE, TAKEOVER, NODES, REPLICAS, SLAVES, MYID,
    ADDSLOTS, DELSLOTS, GETKEYSINSLOT, SETSLOT, NODE, MIGRATING, IMPORTING, STABLE,
    FORGET, FLUSHSLOTS, KEYSLOT, COUNTKEYSINSLOT, SAVECONFIG, REPLICATE;
