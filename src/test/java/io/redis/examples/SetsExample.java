...
public class SetsExample {
  ...
  public void run() {
    ...
    Set<String> res14 = jedis.sinter("bikes:racing:france", "bikes:racing:usa",
      "bikes:racing:italy");
    System.out.println(res14); // >>> [bike:1]

    Set<String> res15 = jedis.sunion("bikes:racing:france", "bikes:racing:usa",
      "bikes:racing:italy");
    System.out.println(res15); // >>> [bike:1, bike:2, bike:3, bike:4]

    Set<String> res16 = jedis
