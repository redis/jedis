...
//
// assertEquals(
// Arrays.asList("NOOFFSETS", "NOFIELDS", "NOFREQS", "TEMPORARY", "1234", "STOPWORDS", "2", "stop",
// "run"),
// arrayList);
// }
//
...
//
// assertEquals(Arrays.asList("ON", "HASH", "ASYNC", "PREFIX", "1", "person:", "FILTER", "@sum<30",
// "LANGUAGE_FIELD",
// "myLanguage", "LANGUAGE", "FR", "SCORE_FIELD", "myScore", "SCORE", "0.818656", "PAYLOAD_FIELD",
// "myPayload"),
// arrayList);
//
