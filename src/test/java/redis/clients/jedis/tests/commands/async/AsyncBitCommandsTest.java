...
public class AsyncBitCommandsTest extends AsyncJedisCommandTestBase {
	...
	// binary
	asyncJedis.setbit(BOOLEAN_CALLBACK.withReset(), "bfoo".getBytes(), 0,
		"1".getBytes());
	assertFalse(BOOLEAN_CALLBACK.getResponseWithWaiting(1000));
	...
	asyncJedis.bitop(new DoNothingCallback<Long>(), BitOP.NOT, "resultNot",
		"key");
