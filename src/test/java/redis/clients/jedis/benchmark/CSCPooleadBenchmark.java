...
public class CSCPooleadBenchmark {
  ...
  public static void main(String[] args) throws Exception {
    ...
    System.out.println(String.format("after %d rounds withoutCache: %d ms,  withCache: %d ms",
      totalRounds, withoutCache, withCache));
  ...
  private static long runBenchmark(Cache cache) throws Exception {
    ...
    System.out.println(String.format("%s round elapsed: %d ms", cache == null ? "no cache"
        : "cached", elapsed));
    return elapsed;
  }
