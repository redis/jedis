...
public interface EvictionPolicy {
  ...
  /**
   * Types of eviction policies AGE - based on the time of access, e.g., LRU FREQ - based on the
   * frequency of access, e.g., LFU HYBR - AGE + FREQ, e.g., CLOCK MISC - Anythin that isn't time
   * based, frequency based or a combination of the two, e.g., FIFO
   */
  enum EvictionType {
    AGE, FREQ, HYBR, MISC
  }
  ...
  /**
   * Evict the next element from the cache This one should provide O(1) complexity
  ...
  /**
   * Indicates that a cache key was touched This one should provide O(1) complexity
