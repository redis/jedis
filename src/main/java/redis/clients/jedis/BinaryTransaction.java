...
public class BinaryTransaction extends Queable {
    ...
    public Response<Set<byte[]>> hkeys(byte[] key) {
        client.hkeys(key);
        return enqueueResponse(BuilderFactory.BYTE_ARRAY_ZSET);
    }
    ...
    public Response<List<byte[]>> hmget(byte[] key, byte[]... fields) {
        ...
        return enqueueResponse(BuilderFactory.BYTE_ARRAY_LIST);
    }
    ...
    public Response<Set<Tuple>> zrangeByScoreWithScores(byte[] key, double min,
        ...
        return enqueueResponse(BuilderFactory.TUPLE_ZSET_BINARY);
    }
