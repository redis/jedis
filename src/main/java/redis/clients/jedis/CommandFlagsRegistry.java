...
/**
 * Registry interface for command flags. Provides a mapping from Redis commands to their flags.
 * This interface allows for different implementations of the flags registry.
 */
