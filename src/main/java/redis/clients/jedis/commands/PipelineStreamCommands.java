...
public interface PipelineStreamCommands {
   ...
   */
//  Response<StreamEntryID> xadd_v2(String key, StreamEntryID id, Map<String, String> hash, long maxLen, boolean approximateLength);
