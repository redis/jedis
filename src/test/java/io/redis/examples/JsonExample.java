...
// HIDE_END
        ...
        // REMOVE_START
        Assert.assertEquals(
            "[{\"specs\":{\"material\":\"aluminium\",\"weight\":7.9},\"price\":2072,\"description\":\"Redesigned for the 2020 model year, this bike impressed our testers and is the best all-around trail bike we've ever tested. The Shimano gear system effectively does away with an external cassette, so is super low maintenance in terms of wear and tear. All in all it's an impressive package for the price, making it very competitive.\",\"model\":\"Quaoar\",\"id\":\"bike:2\",\"colors\":[\"black\",\"white\"]}]",
            res35.toString()
        );
        // REMOVE_END
        ...
        Object res36 = jedis.jsonGet(
            "bikes:inventory",
            new Path2("$..[?(@.specs.material == 'alloy')].model")
        );
        ...
        jedis.jsonSet(
            "bikes:inventory",
            new Path2("$.inventory.mountain_bikes[1].regex_pat"),
            "\"(?i)al\""
        );
        jedis.jsonSet(
            "bikes:inventory",
        ...
        Object res40 = jedis.jsonNumIncrBy(
