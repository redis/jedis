...
public class JedisClusterClientSideCacheTest {
  ...
  @Test
  public void simple() {
    try (JedisCluster jedis = new JedisCluster(hnp, clientConfig.get(), new DefaultClientSideCache())) {
      control.set("foo", "bar");
  ...
  public void simpleWithSimpleMap() {
    ...
    try (JedisCluster jedis = new JedisCluster(hnp, clientConfig.get(), new DefaultClientSideCache(map),
