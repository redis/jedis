...
public class Client extends BinaryClient implements Commands {
  ...
  @Override
  public void lmove(String srcKey, String dstKey, Direction from, Direction to) {
    lmove(SafeEncoder.encode(srcKey), SafeEncoder.encode(dstKey), from, to);
  }

  @Override
  public void blmove(String srcKey, String dstKey, Direction from, Direction to, int timeout) {
