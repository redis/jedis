...
Positive and negative infinity arguments are now encoded as UTF-8 regardless of the JVM's
default charset. Previously, a non-ASCII-compatible default such as UTF-16 produced invalid
`+inf` and `-inf` arguments for sorted-set commands.
