...
/**
 * The interface contain all the commands about client. The params is byte[]
 */
public interface ClientBinaryCommands {
  ...
  /**
   * Returns information and statistics about the client connections server in a mostly
  ...
  /**
   * Returns information and statistics about the client connections server in a mostly
   * human-readable format filter by client type.
   * @return all clients info connected to redis-server
   */
  ...
  /**
   * Returns information and statistics about the client connections server in a mostly
   * human-readable format filter by client ids.
  ...
  /**
   * Returns information and statistics about the current client connection in a mostly
   * human-readable format.
  ...
  /**
   * Unblock from a different connection, a client blocked in a blocking operation, such as for
   * instance BRPOP or XREAD or WAIT.
   * @param clientId The id of the client
   * @return Specifically: 1 if the client was unblocked successfully. 0 if the client wasn't
   *         unblocked.
   */
  ...
  /**
   * A connections control command able to suspend all the Redis clients for the specified amount of
  ...
  /**
   * CLIENT UNPAUSE is used to resume command processing for all clients that were paused by CLIENT
   * PAUSE.
   * @return OK
   */
