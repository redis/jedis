...
public interface ArrayCommands {
   ...
   * @since 8.0
   */
  long ardelrange(String key, long[]... ranges);
   ...
   * @since 8.0
   */
  List<Object> argrep(String key, long start, long end, ArgrepParams params);
   ...
   * @since 8.0
   */
  Map<String, Object> arinfo(String key);
   ...
   * @since 8.0
   */
  Map<String, Object> arinfo(String key, boolean full);
   ...
   * @return the operation's result; a {@link String} for {@code SUM},
   *         {@code MIN}, {@code MAX}; a {@link Long} for {@code AND},
   *         {@code OR}, {@code XOR}, {@code USED}; or {@code null} when no
   *         matching elements are present
   * @since 8.0
   */
  Object arop(String key, long start, long end, ArrayOp op);
   ...
   * @since 8.0
   */
  long aropMatch(String key, long start, long end, String value);
   ...
   * @since 8.0
   */
  List<Object> arscan(String key, long start, long end);
   ...
   * @since 8.0
   */
  List<Object> arscan(String key, long start, long end, long limit);
