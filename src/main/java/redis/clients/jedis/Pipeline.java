...
public class Pipeline extends Queable {
    ...
    @Override
    protected <T> Response<T> enqueueResponse(Builder<T> builder) {
    	if(currentMulti != null){
    		super.enqueueResponse(BuilderFactory.STRING); //Expected QUEUED
    		...
    		return super.enqueueResponse(builder);
    	}
    }
    ...
    public Response<Long> append(String key, String value) {
        ...
        return enqueueResponse(BuilderFactory.LONG);
    }
    ...
    public Response<List<String>> blpop(String... args) {
        client.blpop(args);
        return enqueueResponse(BuilderFactory.STRING_LIST);
    }
    ...
    public Response<String> echo(String string) {
        client.echo(string);
        return enqueueResponse(BuilderFactory.STRING);
    }
    ...
    public Response<Boolean> exists(String key) {
        client.exists(key);
        return enqueueResponse(BuilderFactory.BOOLEAN);
    }
    ...
    public Response<byte[]> get(byte[] key) {
        client.get(key);
        return enqueueResponse(BuilderFactory.BYTE_ARRAY);
    }
    ...
    public Response<Map<String, String>> hgetAll(String key) {
        client.hgetAll(key);
        return enqueueResponse(BuilderFactory.STRING_MAP);
    }
    ...
    public Response<Set<String>> hkeys(String key) {
        client.hkeys(key);
        return enqueueResponse(BuilderFactory.STRING_SET);
    }
    ...
    public Response<Double> zincrby(String key, double score, String member) {
        ...
        return enqueueResponse(BuilderFactory.DOUBLE);
    }
    ...
    public Response<Set<String>> zrange(String key, int start, int end) {
        ...
        return enqueueResponse(BuilderFactory.STRING_ZSET);
    }
    ...
    public Response<Set<Tuple>> zrangeByScoreWithScores(String key, double min,
        ...
        return enqueueResponse(BuilderFactory.TUPLE_ZSET);
    }
    ...
    public Response<List<Object>> exec() {
        client.exec();
        Response<List<Object>> response = super.enqueueResponse(currentMulti);
        currentMulti = null;
        return response;
    }
    ...
    public void multi() {
        client.multi();
        enqueueResponse(BuilderFactory.STRING); //Expecting OK
