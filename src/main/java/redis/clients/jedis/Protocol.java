...
//  }
  ...
  public static enum Command implements ProtocolCommand {
    ...
    STRALGO, GEOSEARCH, GEOSEARCHSTORE, LOLWUT, REPLICAOF, ZRANGESTORE, SINTERCARD, ZINTERCARD,
    SORT_RO, EVAL_RO, EVALSHA_RO, LCS;
  ...
  public static enum Keyword implements Rawable {
    ...
    ANY, FROMMEMBER, FROMLONLAT, BYRADIUS, BYBOX, BYLEX, BYSCORE, REV, IDX, MINMATCHLEN, WITHMATCHLEN;
