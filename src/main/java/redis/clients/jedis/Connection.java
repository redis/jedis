...
public class Connection implements Closeable {
  ...
  public Connection(final String host, final int port, final boolean ssl,
    ...
    this(new DefaultJedisSocketFactory(host, port, Protocol.DEFAULT_TIMEOUT,
        Protocol.DEFAULT_TIMEOUT, 0, ssl, sslSocketFactory, sslParameters, hostnameVerifier));
  }
  ...
  public int getInfiniteSoTimeout() {
    return jedisSocketFactory.getInfiniteSoTimeout();
  }

  public void setInfiniteSoTimeout(int infiniteSoTimeout) {
    jedisSocketFactory.setInfiniteSoTimeout(infiniteSoTimeout);
  }
  ...
  public void setTimeoutInfinite() {
    try {
      ...
      socket.setSoTimeout(jedisSocketFactory.getInfiniteSoTimeout());
