...
public class AsyncSortedSetCommandsTest extends AsyncJedisCommandTestBase {
	...
	Set<byte[]> brange = BYTE_ARRAY_SET_CALLBACK
	...
	assertEquals(bexpected,
		BYTE_ARRAY_SET_CALLBACK.getResponseWithWaiting(1000));
    }
	...
	asyncJedis
		.zrangeWithScores(TUPLE_SET_CALLBACK.withReset(), "foo", 0, 1);
	Set<Tuple> range = TUPLE_SET_CALLBACK.getResponseWithWaiting(1000);
	assertEquals(expected, range);

	expected.add(new Tuple("b", 10d));

	asyncJedis.zrangeWithScores(TUPLE_SET_CALLBACK.withReset(), "foo", 0,
		100);
	...
	asyncJedis.zrangeWithScores(TUPLE_BINARY_SET_CALLBACK.withReset(),
		bfoo, 0, 1);
	Set<Tuple> brange = TUPLE_BINARY_SET_CALLBACK
		.getResponseWithWaiting(1000);
	assertEquals(bexpected, brange);
	...
	asyncJedis.zrevrangeWithScores(TUPLE_SET_CALLBACK.withReset(), "foo",
		0, 1);
	Set<Tuple> range = TUPLE_SET_CALLBACK.getResponseWithWaiting(1000);
	assertEquals(expected, range);
	...
	asyncJedis.zrevrangeWithScores(TUPLE_BINARY_SET_CALLBACK.withReset(),
		bfoo, 0, 1);
	Set<Tuple> brange = TUPLE_BINARY_SET_CALLBACK
		.getResponseWithWaiting(1000);
	assertEquals(bexpected, brange);
	...
	asyncJedis.zscore(DOUBLE_CALLBACK.withReset(), bfoo,
		SafeEncoder.encode("s"));
	score = DOUBLE_CALLBACK.getResponseWithWaiting(1000);
	assertNull(score);
    }
	...
	asyncJedis.zcount(LONG_CALLBACK.withReset(), bfoo,
		SafeEncoder.encode("(0.01"), SafeEncoder.encode("+inf"));
	...
	asyncJedis
		.zrangeByScore(STRING_SET_CALLBACK.withReset(), "foo", 0d, 2d);
	...
	asyncJedis.zrangeByScore(STRING_SET_CALLBACK.withReset(), "foo", 0d,
		2d, 0, 1);
	range = STRING_SET_CALLBACK.getResponseWithWaiting(1000);
	...
	asyncJedis.zrangeByScore(STRING_SET_CALLBACK.withReset(), "foo",
		"-inf", "(2");
	...
	asyncJedis.zrangeByScore(BYTE_ARRAY_SET_CALLBACK.withReset(), bfoo, 0d,
		2d);
	Set<byte[]> brange = BYTE_ARRAY_SET_CALLBACK
		.getResponseWithWaiting(2000);
	...
	asyncJedis.zrangeByScore(BYTE_ARRAY_SET_CALLBACK.withReset(), bfoo,
		SafeEncoder.encode("-inf"), SafeEncoder.encode("(2"));
	Set<byte[]> brange2 = BYTE_ARRAY_SET_CALLBACK
		.getResponseWithWaiting(1000);
	...
	asyncJedis.zrevrangeByScore(STRING_SET_CALLBACK.withReset(), "foo",
		3.5d, Double.NEGATIVE_INFINITY, 0, 2);
	range = STRING_SET_CALLBACK.getResponseWithWaiting(1000);
	...
	asyncJedis.zrevrangeByScore(STRING_SET_CALLBACK.withReset(), "foo",
		3.5d, Double.NEGATIVE_INFINITY, 1, 1);
	range = STRING_SET_CALLBACK.getResponseWithWaiting(1000);
	expected = new LinkedHashSet<String>();
	expected.add("b");
	...
	asyncJedis.zrevrangeByScore(STRING_SET_CALLBACK.withReset(), "foo", 4d,
		2d);
	range = STRING_SET_CALLBACK.getResponseWithWaiting(1000);
	...
	asyncJedis.zrangeByScoreWithScores(TUPLE_SET_CALLBACK.withReset(),
		"foo", 0d, 2d);
	Set<Tuple> range = TUPLE_SET_CALLBACK.getResponseWithWaiting(1000);
	...
	asyncJedis.zrevrangeByScoreWithScores(TUPLE_SET_CALLBACK.withReset(),
	...
	asyncJedis.zrevrangeByScoreWithScores(TUPLE_SET_CALLBACK.withReset(),
		"foo", 3.5d, Double.NEGATIVE_INFINITY, 0, 2);
	range = TUPLE_SET_CALLBACK.getResponseWithWaiting(1000);
	expected = new LinkedHashSet<Tuple>();
	expected.add(new Tuple("c", 3.0d));
	...
	asyncJedis.zrevrangeByScoreWithScores(TUPLE_SET_CALLBACK.withReset(),
		"foo", 3.5d, Double.NEGATIVE_INFINITY, 1, 1);
	range = TUPLE_SET_CALLBACK.getResponseWithWaiting(1000);
	expected = new LinkedHashSet<Tuple>();
	expected.add(new Tuple("b", 2.0d));
	...
	asyncJedis.zrevrangeByScoreWithScores(
		TUPLE_BINARY_SET_CALLBACK.withReset(), bfoo, 2d, 0d);
	Set<Tuple> brange = TUPLE_BINARY_SET_CALLBACK
		.getResponseWithWaiting(1000);
	...
	asyncJedis.zrevrangeByScoreWithScores(
		TUPLE_BINARY_SET_CALLBACK.withReset(), bfoo, 2d, 0d, 0, 1);
	brange = TUPLE_BINARY_SET_CALLBACK.getResponseWithWaiting(1000);
	...
	asyncJedis.zrevrangeByScoreWithScores(
		TUPLE_BINARY_SET_CALLBACK.withReset(), bfoo, 2d, 0d, 1, 1);
	brange = TUPLE_BINARY_SET_CALLBACK.getResponseWithWaiting(1000);
	...
	asyncJedis.zunionstore(LONG_CALLBACK.withReset(),
		SafeEncoder.encode("dst"), bfoo, bbar);
	long bresult = LONG_CALLBACK.getResponseWithWaiting(1000);
	...
	asyncJedis.zunionstore(LONG_CALLBACK.withReset(), "dst", params, "foo",
		"bar");
	long result = LONG_CALLBACK.getResponseWithWaiting(1000);
	...
	asyncJedis.zunionstore(LONG_CALLBACK.withReset(),
		SafeEncoder.encode("dst"), bparams, bfoo, bbar);
	long bresult = LONG_CALLBACK.getResponseWithWaiting(1000);
	...
	asyncJedis.zinterstore(LONG_CALLBACK.withReset(),
		SafeEncoder.encode("dst"), bfoo, bbar);
	long bresult = LONG_CALLBACK.getResponseWithWaiting(1000);
	...
	asyncJedis.zinterstore(LONG_CALLBACK.withReset(), "dst", params, "foo",
		"bar");
	long result = LONG_CALLBACK.getResponseWithWaiting(1000);
