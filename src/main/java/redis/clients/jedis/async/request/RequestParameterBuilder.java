...
public class RequestParameterBuilder {
    ...
    public static byte[][] buildMultiArgsWithArgsLengthParameter(byte[] key,
	    byte[]... keys) {
    ...
    public static byte[][] buildSortWithParameter(byte[] key,
    ...
    public static byte[][] buildSortWithParameter(String key,
	    SortingParams sortingParams) {
	final List<byte[]> args = new ArrayList<byte[]>();
    ...
    public static byte[][] buildSortStoreWithParameter(byte[] key,
    ...
    public static byte[][] buildSortedSetStoreWithParameter(byte[] dstkey,
	    ZParams params, byte[]... sets) {
	final List<byte[]> args = new ArrayList<byte[]>();
	args.add(dstkey);
    ...
    public static byte[][] buildSortedSetStoreWithParameter(String dstkey,
    ...
    public static byte[][] buildSetMultiAddParameter(byte[] key,
	    Map<byte[], byte[]> hash) {
    ...
    public static byte[][] buildSetMultiAddParameter(String key,
	...
	return SafeEncoder
		.encodeMany(params.toArray(new String[params.size()]));
    }
    ...
    public static byte[][] buildBitOpParameter(final BitOP op,
