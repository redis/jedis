...
public class CommandObjects {
  ...
  public final CommandObject<List<TSElements>> tsMRange(long fromTimestamp, long toTimestamp, String... filters) {
  ...
  public final CommandObject<List<TSElements>> tsMRange(TSMRangeParams multiRangeParams) {
  ...
  public final CommandObject<List<TSElements>> tsMRevRange(long fromTimestamp, long toTimestamp, String... filters) {
    return new CommandObject<>(commandArguments(TimeSeriesCommand.MREVRANGE).add(fromTimestamp)
        .add(toTimestamp).add(TimeSeriesKeyword.FILTER).addObjects((Object[]) filters),
        BuilderFactory.TIMESERIES_MRANGE_RESPONSE);
  }

  public final CommandObject<List<TSElements>> tsMRevRange(TSMRangeParams multiRangeParams) {
  ...
  public final CommandObject<List<TSElements>> tsMGet(TSMGetParams multiGetParams, String... filters) {
