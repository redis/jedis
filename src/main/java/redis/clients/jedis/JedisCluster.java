...
public class JedisCluster extends BinaryJedisCluster implements JedisClusterCommands,
   ...
   * @return CustomizeClusterPipeline
   * @Description  从cluster 获自定义 CustomizeClusterPipeline 
   */
  public CustomizeClusterPipeline pipelined()
  {
	  CustomizeClusterPipeline customizeClusterPipeline = new CustomizeClusterPipeline();
	  
	  customizeClusterPipeline.setJedisClusterConnectionHandler(connectionHandler);
