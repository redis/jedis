...
/**
 * JMH benchmark for {@link RedisClient} GET/SET operations on a live Redis server.
 * <p>
 * Benchmarks {@link RedisClient} (pooled connection) operations with concurrency testing.
 * <p>
 * This base class is extended by specific thread-count benchmarks:
 * <ul>
 * <li>{@link RedisClientGetSetBenchmark1Thread}: single-threaded baseline
 * <li>{@link RedisClientGetSetBenchmark8Threads}: moderate concurrency
 * <li>{@link RedisClientGetSetBenchmark64Threads}: high concurrency
 * </ul>
 * <p>
 * Requirements:
 * <ul>
 ...
 * </ul>
 * <p>
 * Run with: {@code mvn -Pjmh test -Djmh.includes="RedisClientGetSetBenchmark"}
 */
