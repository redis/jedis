...
/**
 * JMH Benchmark for SafeEncoder UTF-8 encoding/decoding.
 *
 * Tests the performance of converting between String and byte[] using UTF-8 encoding.
 * This is a critical operation in Redis clients as all Redis protocol data is transmitted as bytes.
 *
 * Benchmarks:
...
public class SafeEncoderBenchmark {
    ...
    /**
     * Batch size for each benchmark invocation.
     * Multiple of TEST_STRINGS.length (6) to ensure each batch tests all patterns equally.
     */
    ...
    /**
     * Benchmark String → byte[] encoding (UTF-8).
     * This operation is used when sending commands and data to Redis.
     */
    @Benchmark
    ...
    /**
     * Benchmark byte[] → String decoding (UTF-8).
     * This operation is used when receiving responses from Redis.
     */
    @Benchmark
    @OperationsPerInvocation(BATCH_SIZE)
    ...
    /**
     * Benchmark encodeMany() - converting multiple strings at once.
     * This is used in some bulk operations.
     */
    @Benchmark
