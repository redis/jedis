...
public class AsyncSlowlogCommandsTest extends AsyncJedisCommandTestBase {
    ...
    public void slowlog() {
	// do something
	asyncJedis.configSet(new DoNothingCallback<String>(),
	...
	List<Slowlog> reducedLog = SLOWLOG_LIST_CALLBACK
	...
	List<byte[]> breducedLog = BYTE_ARRAY_LIST_CALLBACK
		.getResponseWithWaiting(1000);
	...
	List<byte[]> blog1 = BYTE_ARRAY_LIST_CALLBACK
		.getResponseWithWaiting(1000);
	...
	asyncJedis.slowlogGetBinary(BYTE_ARRAY_LIST_CALLBACK.withReset());
	List<byte[]> blog2 = BYTE_ARRAY_LIST_CALLBACK
		.getResponseWithWaiting(1000);
	asyncJedis.slowlogLen(LONG_CALLBACK.withReset());
