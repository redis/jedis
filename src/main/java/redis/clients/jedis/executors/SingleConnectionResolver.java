 ...
 * <p>
 * This resolver is used for broadcast commands where we already have a specific connection from a
 * connection pool and want to use it with the standard retry logic in
 * {@link ClusterCommandExecutor#doExecuteCommand}.
 * <p>
 * <b>Important:</b> This resolver does not manage the connection lifecycle. The connection is
 * expected to be managed externally (e.g., by the caller who obtained it from a pool). The
 * {@code doExecuteCommand} method will close the connection after use.
