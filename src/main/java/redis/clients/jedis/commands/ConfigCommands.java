...
public interface ConfigCommands {
   ...
   * received 5) Number of expired keys 6) Number of rejected connections 7) Latest fork(2) time 8)
  ...
  /**
   * Rewrites the redis.conf file the server was started with, applying the minimal changes needed
   * to make it reflect the configuration currently used by the server, which may be different
