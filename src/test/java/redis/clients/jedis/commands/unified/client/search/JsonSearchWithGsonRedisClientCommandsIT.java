...
public class JsonSearchWithGsonRedisClientCommandsIT extends JsonSearchWithGsonCommandsTestBase {

  public JsonSearchWithGsonRedisClientCommandsIT(RedisProtocol protocol) {
    super(protocol);
  }
