...
public class CacheStats {
  ...
  public String toString() {
    return "CacheStats{" + "hits=" + hits + ", misses=" + misses + ", loads=" + loads + ", evicts="
        + evicts + ", nonCacheable=" + nonCacheable + ", flush=" + flush
        + ", invalidationsByServer=" + invalidationsByServer + ", invalidationMessages="
