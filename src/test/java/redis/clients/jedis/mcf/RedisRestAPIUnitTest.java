...
public class RedisRestAPIUnitTest {
    ...
    void testCheckBdbAvailabilityWithExtendedCheck() throws Exception {
        ...
        verify(api).createConnection(
            eq("https://localhost:8443/v1/local/bdbs/123/availability?extend_check=lag&availability_lag_tolerance_ms=100"),
            eq("GET"), any());
    }
    ...
    void testCheckBdbAvailabilityWithExtendedCheckNoTolerance() throws Exception {
        ...
        verify(api).createConnection(eq("https://localhost:8443/v1/local/bdbs/123/availability?extend_check=lag"), eq("GET"),
            any());
    }
