 ...
 * provides an easy way to broadcast commands. For example, to update the server configuration of
 * all nodes in the Redis Cluster, we broadcast the command [CONFIG
 * SET](https://redis.io/commands/config-set/) to all nodes.
 */
