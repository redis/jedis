...
public class EndpointConfig {
  ...
  public EndpointConfig(HostAndPort hnp, String username, String password, boolean tls) {
    ...
    this.bdbId = 0;
    this.endpoints = Collections.singletonList(URI.create(getURISchema(tls) + hnp.getHost() + ":"
        + hnp.getPort()));
  }
  ...
  public class EndpointURIBuilder {
    ...
    public URI build() {
      String userInfo = !(this.username.isEmpty() && this.password.isEmpty()) ? this.username + ':'
          + this.password + '@' : "";
      return URI
