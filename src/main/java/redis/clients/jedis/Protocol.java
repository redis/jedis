...
public final class Protocol {
  ...
  public static enum Command implements ProtocolCommand {
    ...
    PFADD, PFCOUNT, PFMERGE, READONLY, GEOADD, GEODIST, GEOHASH, GEOPOS, GEORADIUS, georadiusReadOnly,
    GEORADIUSBYMEMBER, georadiusByMemberReadOnly, MODULE, BITFIELD, HSTRLEN, TOUCH, SWAPDB;
