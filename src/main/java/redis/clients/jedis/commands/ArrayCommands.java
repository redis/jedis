...
public interface ArrayCommands {
   ...
   * single-range overload of {@link #ardelrange(String, LongRange...)} that accepts the inclusive
   ...
   * {@link #argrepWithValues(String, ArgrepParams)} to also return the matching values.
   * <p>
