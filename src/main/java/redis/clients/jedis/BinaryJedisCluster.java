...
public class BinaryJedisCluster implements BinaryJedisClusterCommands,
  ...
  public Set<byte[]> hkeys(final byte[] key) {
    return new JedisClusterCommand<Set<byte[]>>(connectionHandler, maxAttempts, this.maxTotalRetriesDuration) {
      @Override
  ...
  public Map<byte[], byte[]> hgetAll(final byte[] key) {
    return new JedisClusterCommand<Map<byte[], byte[]>>(connectionHandler, maxAttempts, this.maxTotalRetriesDuration) {
      @Override
