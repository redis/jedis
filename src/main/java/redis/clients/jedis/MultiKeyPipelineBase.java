...
public abstract class MultiKeyPipelineBase extends PipelineBase implements
  ...
  @Override
  public Response<byte[]> lmove(byte[] srcKey, byte[] dstKey, Direction from, Direction to) {
    client.lmove(srcKey, dstKey, from, to);
    return getResponse(BuilderFactory.BYTE_ARRAY);
  }

  @Override
  public Response<byte[]> blmove(byte[] srcKey, byte[] dstKey, Direction from, Direction to,
      int timeout) {
  ...
  @Override
  public Response<String> lmove(String srcKey, String dstKey, Direction from, Direction to) {
    client.lmove(srcKey, dstKey, from, to);
    return getResponse(BuilderFactory.STRING);
  }

  @Override
  public Response<String> blmove(String srcKey, String dstKey, Direction from, Direction to,
      int timeout) {
    client.blmove(srcKey, dstKey, from, to, timeout);
    return getResponse(BuilderFactory.STRING);
  }
