...
//    } catch (JedisDataException e) {
    ...
    List<TSElements> ranges = client.tsMRange(TSMRangeParams.multiRangeParams(500L, 4600L)
        .aggregation(AggregationType.COUNT, 1).filter("l1=v1"));
    assertEquals(1, ranges.size());

    TSElements range = ranges.get(0);
    ...
    List<TSElements> ranges2 = client.tsMRange(TSMRangeParams.multiRangeParams(500L, 4600L)
    ...
    List<TSElements> ranges3 = client.tsMRange(TSMRangeParams.multiRangeParams(500L, 4600L)
...
//  }
  ...
  public void mrangeFilterBy() {
    ...
    // MRANGE
    List<TSElements> range = client.tsMRange(0L, 5000L, filter);
...
//        .groupByReduce("metric_name", "max"), "metric=cpu");
    List<TSElements> range = client.tsMRange(TSMRangeParams.multiRangeParams(0L, 100L).withLabels()
  ...
  public void testMGet() {
    ...
    // Test for empty result
    List<TSElements> ranges1 = client.tsMGet(TSMGetParams.multiGetParams().withLabels(false), "l1=v2");
    assertEquals(0, ranges1.size());

    // Test for empty ranges
    List<TSElements> ranges2 = client.tsMGet(TSMGetParams.multiGetParams().withLabels(true), "l1=v1");
    ...
    List<TSElements> ranges3 = client.tsMGet(TSMGetParams.multiGetParams().withLabels(false), "l1=v1");
    assertEquals(2, ranges3.size());
...
//  }
  ...
  public void testMRevRange() {
    ...
    assertEquals(2222L, client.tsAdd("seriesMRevRange1", 2222L, 3.1,
        TSCreateParams.createParams().retention(10000).labels(labels1)));
    List<TSElements> ranges1 = client.tsMRevRange(TSMRangeParams.multiRangeParams(500L, 4600L)
        .aggregation(AggregationType.COUNT, 1).withLabels().filter("l4=v4"));
    ...
    assertEquals(1111L, client.tsAdd("seriesMRevRange2", 1111L, 99.99,
        TSCreateParams.createParams().retention(10000).labels(labels2)));
    List<TSElements> ranges2 = client.tsMRevRange(500L, 4600L, "l3=v3");
    assertEquals(2, ranges2.size());
    ...
    List<TSElements> ranges3 = client.tsMRevRange(TSMRangeParams.multiRangeParams(500L, 4600L)
